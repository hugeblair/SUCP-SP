 ...
 * 
 */
public class HUSP_SP_Contrast_BaseTest {
...
//        double minContrastUtility = Double.parseDouble(args[2]);
        ...
        // run the algorithm
        HUSP_SP_Contrast_minUtilityPruning huspMiner = new HUSP_SP_Contrast_minUtilityPruning(input1, input2, minUtility1, minContrastUtility);
