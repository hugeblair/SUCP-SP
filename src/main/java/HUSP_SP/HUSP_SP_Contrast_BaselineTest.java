 ...
 * 
 */
public class HUSP_SP_Contrast_BaselineTest {
...
//        double minUtility1 = 0.00024;
//        double minContrastUtility = 5;
...
//        double minContrastUtility = Double.parseDouble(args[2]);
        ...
        // run the algorithm
        HUSP_SP_Contrast_Baseline huspMiner = new HUSP_SP_Contrast_Baseline(input1, input2, minUtility1, minContrastUtility);
