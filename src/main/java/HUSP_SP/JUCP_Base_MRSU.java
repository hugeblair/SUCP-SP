...
//    protected String output;
     ...
     */
    public JUCP_Base_MRSU(String input1, String input2, double minRatio, double minContrastUtility) {
        this.input1 = input1;
        this.input2 = input2;
...
//    }
    ...
    void firstConcatenation() throws IOException {
        ...
        for (Map.Entry<Integer, Integer> entry : mapItemTRSU1.entrySet()) {
            if (entry.getValue() >= minUtility1 && mapItemTRSU2.getOrDefault(entry.getKey(), 0) != 0) {
                candidateNum += 1;
