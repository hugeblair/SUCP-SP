 ...
 * 
 */
public class HUSP_SP_Contrast_MRSUTest {
...
//        String input2 = "../dataFile/" + dataset + "_N.txt";
        ...
        String output = "crime_SUCP_P_200.txt";

        // run the algorithm
        HUSP_SP_Contrast_MRSU huspMiner = new HUSP_SP_Contrast_MRSU(input1, input2, minUtility1, minContrastUtility,output);
