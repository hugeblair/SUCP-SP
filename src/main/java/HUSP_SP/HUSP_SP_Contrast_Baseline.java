...
public class HUSP_SP_Contrast_Baseline {
...
//    protected String output;
     ...
     */
    public HUSP_SP_Contrast_Baseline(String input1, String input2, double minRatio, double minContrastUtility) {
        this.input1 = input1;
        this.input2 = input2;
...
//                double contrastUpper = upRatio2 == 0 ? minContrastUtility : upRatio1 / upRatio2;
                ...
                prefix.add(addItem);
                if(isPattern)
                    patterns.add(prefix+ "u1 / u2: "+ String.format("%.5f", cUtil) + ", upper2: " + utilityUpper2);
...
//        HashSet<Integer> iExtensionItems2 = getIExtensionItems(projectULinkListDB2, isRemove2);
        iConcatenation(projectULinkListDB1, projectULinkListDB2, mapItemIConcatenationSwu1, minInstanceUtility1, minInstanceUtility2);
...
//        HashSet<Integer> sExtensionItems2 = getSExtensionItems(projectULinkListDB2, isRemove2);
        sConcatenation(projectULinkListDB1, projectULinkListDB2, mapItemSConcatenationSwu1, minInstanceUtility1, minInstanceUtility2);
...
//            double contrastUpp = ((double) swu1 / totalUtility1) / ((double) minInstanceUtility2_O / totalUtility2);
            if (swu1 >= minUtility1 ) {
                candidateNum += 1;
                int addItem = entry.getKey();
...
//        System.out.println("minContrastUtility: " + minContrastUtility);
        ...
        System.out.println("MinUtility2: " + minUtility2);
