 ...
 * 
 */
public class HUSP_SP_JumpPattern_Test {
...
//        double minContrastUtility = Double.parseDouble(args[2]);
        ...
        String dataset = "Yoochoose";
        double minUtility1 =0.00005;
        double minContrastUtility = 1.5;

//        String dataset = "SIGN";
//        double minUtility1 =0.0001;
//        double minContrastUtility = 50;

//        String dataset = "BIBLE";
//        double minUtility1 =0.00001;
//        double minContrastUtility = 100;
        ...
        // run the algorithm
        HUSP_SP_JumpPattern_algo huspMiner = new HUSP_SP_JumpPattern_algo(input1, input2, minUtility1, minContrastUtility);
