 ...
 * 
 */
public class JUCP_CPS_MRSU_Test {
...
//        double minContrastUtility = Double.parseDouble(args[2]);
        ...
        String dataset = "Kosarak10k";
        double minUtility1 =0.0125;
        double minContrastUtility = 1.05;

        String input1 = "../dataFile/" + dataset + "_P.txt";
        String input2 = "../dataFile/" + dataset + "_N.txt";
        String output = "JUCP_CPS_MRSU_Res.txt";

        // run the algorithm
        JUCP_CPS_MRSU huspMiner = new JUCP_CPS_MRSU(input1, input2, minUtility1, minContrastUtility);
