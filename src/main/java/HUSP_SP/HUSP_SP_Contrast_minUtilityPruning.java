...
public class HUSP_SP_Contrast_minUtilityPruning {
...
//    protected String output;
     ...
     */
    public HUSP_SP_Contrast_minUtilityPruning(String input1, String input2, double minRatio, double minContrastUtility) {
        this.input1 = input1;
        this.input2 = input2;
