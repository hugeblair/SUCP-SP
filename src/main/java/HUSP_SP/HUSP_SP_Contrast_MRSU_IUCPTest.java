 ...
 * 
 */
public class HUSP_SP_Contrast_MRSU_IUCPTest {
...
//        double minContrastUtility = Double.parseDouble(args[2]);
        ...
        double minUtility1 = 0.9;
        double minContrastUtility = 10;

        String input1 = "../dataFile/" + dataset + "_P.txt";
        String input2 = "../dataFile/" + dataset + "_N.txt";
        String output = "Crime_IUCP_P.txt";

        // run the algorithm
        HUSP_SP_Contrast_MRSU_IUCP huspMiner = new HUSP_SP_Contrast_MRSU_IUCP(input1, input2, minUtility1, minContrastUtility,output);
