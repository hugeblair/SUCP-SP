...
public class HUSP_SP_Contrast_MRSU_IUCP {
...
//    protected String output;
     ...
     */
    public HUSP_SP_Contrast_MRSU_IUCP(String input1, String input2, double minRatio, double minContrastUtility, String output) {
        this.input1 = input1;
        this.input2 = input2;
    ...
    void firstConcatenation() throws IOException {
        ...
        for (Map.Entry<Integer, Integer> entry : mapItemTRSU1.entrySet()) {
            if (entry.getValue() >= minUtility1) {
                ...
                boolean isPattern = cUtil >= minContrastUtility && u1 >= minUtility1;
